...
- Prior plan artifacts inspected:
  ...
  - `docs/archive/plans/default-local-pty-process-runtime.md` from `origin/main`
  - `docs/archive/plans/supervised-session-task-runtime-core-engine.md` from `origin/main`
