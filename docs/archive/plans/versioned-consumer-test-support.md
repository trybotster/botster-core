...
- Prior dependency context: `docs/archive/plans/contract-test-fixtures-regression-shapes.md` established preserve/translate/drop regression fixtures and a separate `botster-core-test-support` crate.
...
- `docs/archive/plans/versioned-consumer-test-support.md` if Plan Review requests refinement
