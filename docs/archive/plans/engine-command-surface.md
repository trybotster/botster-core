...
- Prior plan artifacts inspected:
  ...
  - `docs/archive/plans/minimal-real-embedder-example.md`
...
- `docs/archive/plans/engine-command-surface.md`
  - This plan artifact.
- `crates/botster-core/src/engine/botster.rs`
...
- Convention conflicts: none. The plan keeps workflow/product policy outside `botster-core`, preserves typed core controls, and uses a repo-visible plan artifact because this repository has `docs/archive/plans/`.
