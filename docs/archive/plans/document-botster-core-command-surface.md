...
- Repo context inspected:
  ...
  - `docs/archive/plans/typed-engine-command-api.md`
...
- Plan artifact: `docs/archive/plans/document-botster-core-command-surface.md`.
...
- `crates/botster-core-dev/src/lib.rs`
  - Module doc correction if needed to describe the real default local engine
    smoke path.
- `docs/archive/plans/document-botster-core-command-surface.md`
  - This plan artifact.
