...
- Repo context inspected:
  ...
  - existing plan artifacts in `docs/archive/plans/`, especially the multiplexer, session worker, subscription, notification, plugin worker, and dev-engine example plans.
...
- `docs/archive/plans/reframe-botster-core-docs-embeddable-tmux-engine.md`
  - This plan artifact.
- Optional targeted existing docs links:
  - `docs/archive/plans/assemble-core-multiplexer-engine-api.md`
  - `docs/archive/plans/botster-core-dev-engine-smoke-examples.md`
