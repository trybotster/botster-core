...
- Relevant prior plan artifacts: `docs/archive/plans/ui-node-v1-primitives-forms-field-schemas.md`, `docs/archive/plans/ui-action-validation-envelopes.md`, and `docs/archive/plans/ui-capability-bindings-conformance-fixtures.md`.
