...
- Repo context inspected:
  ...
  - `docs/archive/plans/default-pty-runtime-multiplexer-engine-integration.md`
  - `docs/archive/plans/session-process-wire-protocol.md`
  - `docs/archive/plans/ghostty-shadow-terminal-architecture.md`
...
- The ticket's "cargo docs/tests still pass" acceptance does not require code
  ...
  README/rustdoc-adjacent docs can affect docs builds. `docs/archive/plans/*.md` are
...
- `docs/archive/plans/*.md` edits will not directly affect rustdoc, so cargo doc/test
