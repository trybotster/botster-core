...
- Repo context inspected:
  ...
  - Existing plan artifacts loaded: `docs/plans/session-process-wire-protocol.md`, `docs/plans/core-session-worker-engine.md`, `docs/plans/process-group-cleanup-shutdown-guarantees.md`, and `docs/plans/bound-pty-output-queues-and-surface-backpressure.md`.
...
- Plan artifact: `docs/plans/local-session-worker-process-runtime.md`.
