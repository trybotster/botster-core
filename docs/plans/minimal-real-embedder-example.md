...
- Repo context loaded:
  ...
  - `docs/plans/botster-core-dev-engine-smoke-examples.md`: prior plan added a fake session/client/plugin smoke harness.
...
- Plan artifact: `docs/plans/minimal-real-embedder-example.md`.
